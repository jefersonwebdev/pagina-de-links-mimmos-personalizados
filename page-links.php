...
<body class="py-12 px-4 relative overflow-x-hidden">
    ...
    <div class="max-w-md mx-auto relative z-10 text-center">
        ...
        <p class="text-gray-600 mb-10 font-medium px-4">Sublimação, papelaria personalizada, brindes e presentes inesquecíveis. ✨</p>
        ...
        <footer class="mt-16 pb-8 text-gray-400 text-xs tracking-widest uppercase font-medium">
            ...
            <div class="mt-2 flex justify-center space-x-1 items-center">
                ...
                <span>por
                    <a href="https://solucoeswebpro.com.br" target="_blank" style="color: var(--mimmos-dark-pink);">Soluções Web Pro</a>
                </span>
            </div>
        </footer>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const cards = document.querySelectorAll('.link-card, .pt-6');
